...
public class RegistrasiUserActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp = findViewById(R.id.btn_daftar_user);
        btnSignUp.setOnClickListener(this);

        tvSignIn = findViewById(R.id.tv_masuk);
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Intent sigInInten = new Intent(RegistrasiUserActivity.this, LoginActivity.class);
